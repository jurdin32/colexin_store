...
class Order(models.Model):
    ...
    status = models.CharField(max_length=50, choices=choices,
                                                default=OrderStatus.CREADO) #Enum
    ...
    def update_shipping_address(self,shipping_addresses):
        self.shipping_address = shipping_addresses
        self.save()
    ...
    def complete(self):
        self.status = OrderStatus.COMPLETADO
        self.save()
    ...
    def get_total(self):
        return self.cart.total + self.total_envio - decimal.Decimal( self.get_discount())

    @property
    def description(self):
        return 'Colexin - Compra por ({}) producto(s)'.format(
