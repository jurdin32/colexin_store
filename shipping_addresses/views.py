...
from colexin.models import Colexin
...
class ShippingAddressDelateView(LoginRequiredMixin,DeleteView):
    login_url = 'login'
    model = ShippingAddress
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        return super(ShippingAddressDelateView, self).dispatch(request, *args, **kwargs)
